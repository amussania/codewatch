...
export default function ProblemSection() {
  return (
    <section className="py-[100px] bg-[#f8faff]" id="features">
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        {/* Problem cards — 1px border grid, staggered */}
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#e2e2ee] border border-t-0 border-[#e2e2ee] rounded-b-xl overflow-hidden"
        >
          {STATS.map((s) => (
            <div key={s.label} className="bg-[#f8faff] px-6 py-5 text-center">
